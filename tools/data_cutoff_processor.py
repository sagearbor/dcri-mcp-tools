...
def run(input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if 'data_cutoff_processor' == 'kaplan_meier_creator':
        results.update(_survival_analysis(data, params))
    elif 'data_cutoff_processor' == 'baseline_comparability_tester':
        results.update(_baseline_comparison(data, params))
    elif 'data_cutoff_processor' == 'efficacy_endpoint_calculator':
        results.update(_efficacy_calculation(data, params))
    elif 'data_cutoff_processor' == 'statistical_report_generator':
        results.update(_generate_report(data, params))
    elif 'data_cutoff_processor' == 'data_cutoff_processor':
        results.update(_process_cutoff(data, params))
    elif 'data_cutoff_processor' == 'subgroup_analysis_tool':
        results.update(_subgroup_analysis(data, params))
    elif 'data_cutoff_processor' == 'sensitivity_analysis_runner':
