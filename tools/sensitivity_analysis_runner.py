"""
sensitivity analysis runner Tool
...
def run(input_data: Dict[str, Any]) -> Dict[str, Any]:
    """Run sensitivity analysis runner analysis."""
    ...
    results = {
        'tool': 'sensitivity_analysis_runner',
    ...
    if 'sensitivity_analysis_runner' == 'kaplan_meier_creator':
        results.update(_survival_analysis(data, params))
    elif 'sensitivity_analysis_runner' == 'baseline_comparability_tester':
        results.update(_baseline_comparison(data, params))
    elif 'sensitivity_analysis_runner' == 'efficacy_endpoint_calculator':
        results.update(_efficacy_calculation(data, params))
    elif 'sensitivity_analysis_runner' == 'statistical_report_generator':
        results.update(_generate_report(data, params))
    elif 'sensitivity_analysis_runner' == 'data_cutoff_processor':
        results.update(_process_cutoff(data, params))
    elif 'sensitivity_analysis_runner' == 'subgroup_analysis_tool':
        results.update(_subgroup_analysis(data, params))
    elif 'sensitivity_analysis_runner' == 'sensitivity_analysis_runner':
