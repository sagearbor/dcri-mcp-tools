...
def run(input_data: Dict[str, Any]) -> Dict[str, Any]:
    """Run subgroup analysis tool analysis."""
    ...
    if 'subgroup_analysis_tool' == 'kaplan_meier_creator':
        results.update(_survival_analysis(data, params))
    elif 'subgroup_analysis_tool' == 'baseline_comparability_tester':
        results.update(_baseline_comparison(data, params))
    elif 'subgroup_analysis_tool' == 'efficacy_endpoint_calculator':
        results.update(_efficacy_calculation(data, params))
    elif 'subgroup_analysis_tool' == 'statistical_report_generator':
        results.update(_generate_report(data, params))
    elif 'subgroup_analysis_tool' == 'data_cutoff_processor':
        results.update(_process_cutoff(data, params))
    elif 'subgroup_analysis_tool' == 'subgroup_analysis_tool':
        results.update(_subgroup_analysis(data, params))
    elif 'subgroup_analysis_tool' == 'sensitivity_analysis_runner':
